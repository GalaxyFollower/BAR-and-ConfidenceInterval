...
implicit none
   ...
   ! Liquid phase partition functions and ZPC for OH cleavage of Ethylene Glycol calculated at 500K
   real(dp), parameter :: ZPCRxn	=  -0.217585325785040_dp
   real(dp), parameter :: ZPCFor        =  -0.215559262268952_dp
   real(dp), parameter :: QvibR		=   46591.96538100040_dp
   real(dp), parameter :: QvibTS	=   6746.934240611910_dp
   real(dp), parameter :: QvibP		=   13483.72963393990_dp
